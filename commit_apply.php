...
if(isset($_SESSION['email']) AND! empty($_SESSION['email']) and isset($_SESSION['password']) AND !empty($_SESSION['password'])){
	$ID = $_SESSION['ID'];
			...
			$result = $db->query("INSERT into applied values('$ID','$course_id')");
			if(!$result){
				...
				$_SESSION['message'] = "You have already Applied to this course<br> You can not apply to a particular course more than once!";
				header("location: php/error.php");
			}
				...
				<div class="col-md-12 col-md-offset-0 text-left">
					<div class="row row-mt-15em">
						...
						<div class="col-md-7 mt-text animate-box" data-animate-effect="fadeInUp">
							<span class="intro-text-small">You have applied for this course:</span>
