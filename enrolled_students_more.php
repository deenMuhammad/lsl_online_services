...
$result = $db->query("SELECT photo, name, email from applicant_photo natural join (select ID , name, email from applicant NATURAL join (SELECT * from enrolled where course_id = '".$course_id."') as T) as TT");
if($result){
...
<html>
	...
	<title><?php echo $course_title ?> Journal</title>
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
				...
				<div class="col-md-12 col-md-offset-0 text-left">
					<div class="row row-mt-15em">
						...
						<div class="col-md-7 mt-text animate-box" data-animate-effect="fadeInUp">
							<span class="intro-text-small">LSL Family has been widening!</span>
							<h2>Students Below are a part of LSL Family!</h2>
						</div>
	...
	<div style="border-bottom:2px dashed #d4f142;" class="gtco-section border-bottom">
		<div class="gtco-container">
			<div class="row" >
			<h2>Current Journal of <b><i>"<?php echo $course_title?>"</i> </b>: </h2>
			<br>
            <?php if(sizeof($row_application_array)==0){ echo '<h2 class = "alert alert-info">This course has not got enrolled students now!</h2>';}
            else{
                echo '
                            ...
                            echo '</table>
                            <a href = "php/print_enrolled_table.php?course_id='.$course_id.'&title='.$course_title.'" target = "_blank"><button style="float:right;" class = "btn btn-primary" type = "submit"><span class="glyphicon glyphicon-print"></span> Print Table</button></a>
                            </form>';	
                        }
                        ?>
				<?php
