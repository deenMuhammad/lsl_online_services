		...
		<div class="gtco-container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2 text-center gtco-heading">
					...
					<p>Join over 1000 of users. Dignissimos asperiores vitae velit veniam totam fuga molestias accusamus alias autem provident. Odit ab aliquam dolor eius.</p>
				</div>
			</div>
			<div class="row">
				<div class="col-md-4">
		...
		<div class="gtco-container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2 text-center gtco-heading animate-box">
					...
					<p>We are trying very hard to deliver world-class education facilities with the lates updates</p>
				</div>
			</div>
			<div class="row">
				<div class="col-md-8 col-md-offset-2">
					<ul class="fh5co-faq-list">
						<li class="animate-box">
							<h2>What is LSL?</h2>
							<p>LSL is a private education center founded in 2016 in Namangan City. The Eduaction Center soon is aiming to become a private education academy. Unless it has been long time since it started to nurture its first students, the reputation of the education center has spread around the country.</p>
						</li>
						<li class="animate-box">
							<h2>Are there any prerequisites before becoming LSL applicant?</h2>
						...
						<li class="animate-box">
							<h2>How do I use LSL Online features?</h2>
							<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean.</p>
						</li>
						<li class="animate-box">
							<h2>Is LSL free??</h2>
