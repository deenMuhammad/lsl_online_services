				...
				<div class="col-md-12 col-md-offset-0 text-left">
					<div class="row row-mt-15em">
						...
						<div class="col-md-7 mt-text animate-box" data-animate-effect="fadeInUp">
							<span class="intro-text-small">Glad to see you!</span>
							<h2>Dear <?php echo $user['name'];?></h2>
							<span class="intro-text-small">Currently:</span>
							<span class="intro-text-small"><p style="display: inline; background: #d4f142; color: black;border-radius:10% 40%; padding:3px; outline: none;border-color: #9ecaed;box-shadow: 0 0 10px #9ecaed;"><?php echo $pending_application_request;?></p>  Application Requests</span>
