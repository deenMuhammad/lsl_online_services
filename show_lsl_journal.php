...
$result = $db->query("select course_id, title, st_count, photo from teachers NATURAL join (SELECT * from teaches natural join (select title, course_id, count(distinct ID) as st_count from courses natural left join enrolled group by course_id) as T) as TT");
if($result){
				...
				<div class="col-md-12 col-md-offset-0 text-left">
                    ...
                    ?>
						<div class="col-md-7 mt-text animate-box" data-animate-effect="fadeInUp">
							<span class="intro-text-small">Currently <h6 style="display: inline; background: #d4f142; color: black;border-radius:10% 40%; padding:3px; outline: none;border-color: #ff0000;box-shadow: 0 0 10px #ff0000;"> <?php echo $sum?></h6> online applicants have enrolled to Courses in our</span>
							<h2>Online LSL Journal!</h2>	
						</div>
			...
			<br>
				...
				<div  class="fh5co-card-item">
					...
					<div class="fh5co-text">
						...
						<p>Total Enrolled: <h6 style="display: inline; background: #d4f142; color: black;border-radius:10% 40%; padding:3px; outline: none;border-color: #ff0000;box-shadow: 0 0 10px #ff0000;">'.$num.'</h6></p>
						<a href = "enrolled_students_more.php?course_id='.$rows['course_id'].'&title='.$rows['title'].'"><button class="btn btn-primary" type="button">More</button></a>
					</div>
				</div>
			</div>';
				}
