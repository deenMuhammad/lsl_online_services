...
$query_one = "UPDATE admin SET pass = '$password' where email = '$email'";
...
$query = "SELECT * FROM admin WHERE email = '$email'";
    ...
    if($results->num_rows==0){
        $_SESSION['message'] = "The email: <i><b>".$email."</b></i> is not registered in our database as administrator! <br>Please try to use valid email!";
...
try {
    ...
    $body = "<h2>LSL Setting Administrator Password</h2>
    <strong>Thank You Admin for staying up with LSL</strong>
